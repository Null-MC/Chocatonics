...
//	wpos.y = clamp(wpos.y,0.0,1.0);
	...
	vec3 ambientLight = ambientUp * saturate(ambientCoefs.y);
	ambientLight += ambientDown * saturate(-ambientCoefs.y);
	ambientLight += ambientRight * saturate(ambientCoefs.x);
	ambientLight += ambientLeft * saturate(-ambientCoefs.x);
	ambientLight += ambientB * saturate(ambientCoefs.z);
	ambientLight += ambientF * saturate(-ambientCoefs.z);
